                ...
                <form method="POST" action="{{route('update.profile')}}" enctype="multipart/form-data">
                    ...
                    <div class="row mbn-20">
                        ...
                        <div class="col-12 mb-20">
                            ...
                            <input type="text" id="formLayoutUsername1" class="form-control" placeholder="Name" name="name" value="{{$user->name}}">
                        </div>
                        <div class="col-12 mb-20">
                            <label for="formLayoutUsername1">Phone</label>
                            <input type="text" id="formLayoutUsername1" class="form-control" placeholder="Phone" name="phone" value="{{$user->phone}}">
                        </div>
