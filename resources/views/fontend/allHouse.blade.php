            ...
            <div class="col-md-12">
                <div class="apartment-tab-area">
                    <ul role="tablist" class="nav nav-tabs apartment-menu hidden-xs hidden-sm">
                        ...
                        <li>
                            <a href="{{route('house.new.to.old')}}" >Date<span>Newest to oldest</span></a>
                        </li>
                        <li>
                            <a href="{{route('house.old.to.new')}}">Date <span>Older to newest</span> </a>
                        </li>
                        <li>
                            <a href="{{route('house.new.to.old.price')}}">Price<span>Low to high</span></a>
                        </li>
                        <li>
                            <a href="{{route('house.old.to.new.price')}}" >Price<span>high to low</span></a>
                        </li>
                    </ul>
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-6">
                                    <div class="apartments-content">
                                        <div class="image-content">
                                            <a href="{{route('house.single',$house->id)}}">
                                                <img src="{{ asset($house->image) }}" alt="apartment" />
                                            </a>
                                        </div><!-- /.image-content -->
                                        ...
                                        <div class="text-content">
                                            <div class="top-content">
                                                <h3>
                                                    <a href="{{route('house.single',$house->id)}}">{{$house->title}}</a>
                                                </h3>
                                               <span>
