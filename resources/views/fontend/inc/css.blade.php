	<!-- Favicons
    ================================================== -->
    <!-- <link rel="shortcut icon" href="{{asset('fontend')}}/assets/images/house-logo.png"> -->
    <!-- <link rel="apple-touch-icon" href="{{asset('fontend')}}/assets/images/apple-touch-icon.png">
    <link rel="apple-touch-icon" sizes="72x72" href="{{asset('fontend')}}/images/apple-touch-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="114x114" href="{{asset('font -->end')}}/images/apple-touch-icon-114x114.png">
    ...
    <link rel="stylesheet" href="{{asset('fontend')}}/assets/css/colors.css">
