    <!-- ====== Footer Area ====== --> 
    <footer class="footer-area" style="background-image: url({{asset('fontend/assets/images/footer-bg.png')}})">
       <div class="container">
           <div class="row">
               <div class="col-md-4">
                   <div class="widget widget_about yellow-color">    
                       ...
                       <div class="widget-about-content">
                           <img src="{{asset('fontend')}}/assets/images/footer-logo.png" alt="house" />
               ...
               <div class="col-md-4">
                   <div class="widget widget_instagram yellow-color">
                       ...
                       <div class="instagram-image-content">
                           <a href="#"><img src="{{asset('fontend')}}/assets/images/instagram/instagram-one.png" alt="" /></a>
                           <a href="#"><img src="{{asset('fontend')}}/assets/images/instagram/instagram-two.png" alt="" /></a>
                           <a href="#"><img src="{{asset('fontend')}}/assets/images/instagram/instagram-three.png" alt="" /></a>
                           <a href="#"><img src="{{asset('fontend')}}/assets/images/instagram/instagram-four.png" alt="" /></a>
                           <a href="#"><img src="{{asset('fontend')}}/assets/images/instagram/instagram-five.png" alt="" /></a>
                           <a href="#"><img src="{{asset('fontend')}}/assets/images/instagram/instagram-six.png" alt="" /></a>
