                ...
                <div class="col-xs-12 tb">
                    <div class="mobile-header-block">
                        ...
                        <div class="logo-area tb-cell">
                            <div class="site-logo">
                                <a href="{{route('home')}}">
                                    <img src="{{asset('fontend')}}/assets/images/logo.png" alt="site-logo" />
                                </a>
                            </div><!-- /.site-logo -->
                        </div><!-- /.logo-area -->
                    ...
                    <div class="col-md-5 col-sm-5 mobile-center">
                        <div class="left-content">
                            <ul>
                                ...
                                <li>
                                    <a href="{{route('user.dashboard')}}">My Accout</a>
                                </li>
                                
                                <li>
                                    <a href="{{route('user.dashboard')}}"><img style="height:30px;width: 30px; border-radius: 50%;" src="{{asset(Auth::user()->image)}}"></a>
                                </li>
                                @endif
                                @if( Auth::user()->role_id != 3 )
                                <li>
                        ...
                        <div class="menu-wrapper">
                            <div class="menu-content">
                                <ul class="menu-list">
                                    ...
                                    <li>
                                        <a href="{{route('house.all')}}">All Apartment</a>
                                    </li>
                ...
                <div id="cd-login"> 
                    <form class="cd-form"method="POST" action="{{ route('login') }}">
                        ...
                        <p class="fieldset">
                            ...
                            <input class="full-width has-padding has-border" id="signin-email" type="email" placeholder="E-mail" name="email" value="{{ old('email') }}">
                            @error('email')
