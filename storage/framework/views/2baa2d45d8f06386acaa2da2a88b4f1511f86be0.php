  ...
  <div class="row">
    <div class="col-md-8 order-md-1">
      ...
      <form action="<?php echo e(route('stripe.order')); ?>" method="post" id="payment-form">
        ...
        <input type="hidden" name="house_id" value="<?php echo e($bHouse->house->id); ?>">
        <input type="hidden" name="id" value="<?php echo e($bHouse->id); ?>">
        <input type="hidden" name="total_rent" value="<?php echo e($totalPrice); ?>">
        <input type="hidden" name="total_rent_with_commission" value="<?php echo e($price_with_commison); ?>">
        <input type="hidden" name="commission" value="<?php echo e($comission); ?>">
        <input type="hidden" name="days" value="<?php echo e($intervel); ?>">
        <input type="hidden" name="house_owner_id" value="<?php echo e($bHouse->house_owner_id); ?>">
        <div class="form-row">
      ...
      <img src="<?php echo e(asset('fontend/assets/images/ssl.png')); ?>" class="card-img-top" alt="...">
    </div>
    <div class="col-md-4 order-md-2 mb-4">


      <div class="card" style="width: 18rem;">
        <img src="<?php echo e(asset($bHouse->house->image)); ?>" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title"><?php echo e($bHouse->house->title); ?></h5>
        </div>
            ...
            <div class="row">
              <table class="table table-striped">
                ...
                <tr>
                  ...
                  <td class="=text-right"><?php echo e($intervel); ?></td>
                ...
                <tr>
                  ...
                  <td><?php echo e($comission); ?></td>
                </tr>
                <tr>
                  <th scope="row">Total (Taka)</th>
                  <td><?php echo e($price_with_commison); ?></td>
                </tr>
                </tbody>
              </table>
...
<?php echo $__env->make('layouts.fontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mikan\Desktop\FALL 2021\cse499b\HouseRent\resources\views/fontend/confirmBookHouse.blade.php ENDPATH**/ ?>