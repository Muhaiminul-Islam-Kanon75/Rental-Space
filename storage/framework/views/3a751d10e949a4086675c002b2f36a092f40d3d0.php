            ...
            <div class="side-header-inner custom-scroll">
                ...
                <nav class="side-header-menu" id="side-header-menu">
                    <ul>
                        ...
                        <li><a href="<?php echo e(route('house.all')); ?>"><i class="ti-home"></i> <span>All House</span></a></li>
        ...
        </div><!-- Side Header End --><?php /**PATH D:\web\hoese rent\HouseRent\resources\views/backend/inc/sidebar.blade.php ENDPATH**/ ?>