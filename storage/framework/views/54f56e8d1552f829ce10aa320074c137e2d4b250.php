    ...
    <div class="row">
      <div class="col-md-8 order-md-1">
          ...
          <form action="<?php echo e(route('stripe.order')); ?>" method="post" id="payment-form">
                            ...
                            <input type="hidden" name="house_owner_id" value="<?php echo e($bHouse->user_id); ?>">
                        <div class="form-row">
...
<?php echo $__env->make('layouts.fontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web\hoese rent\HouseRent\resources\views/fontend/confirmBookHouse.blade.php ENDPATH**/ ?>