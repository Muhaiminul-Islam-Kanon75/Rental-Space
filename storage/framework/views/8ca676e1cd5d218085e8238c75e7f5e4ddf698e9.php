            ...
            <div class="col-md-10">
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active row" id="home">
                        ...
                        <div class="col-md-6">
                            <div class="image-content">
                                <img src="<?php echo e(asset('fontend')); ?>/assets/images/about-image.png" alt="about" />
                            </div><!-- /.text-content -->
                        </div><!-- /.col-md-6 -->
                    </div> <!-- /.home -->
                    ...
                    <div role="tabpanel" class="tab-pane fade row" id="messages">
                        ...
                        <div class="col-md-6">
                          <div class="image-content">
                              <img src="<?php echo e(asset('fontend/
                              assets/images/about-image.png')); ?>" alt="about" />
                          </div><!-- /.text-content -->
                        </div><!-- /.col-md-6 -->
                     </div> <!-- /.messages -->
                </div> <!-- /.tab-content -->
...
</div> <!-- /.aboutus-area --><?php /**PATH D:\web\hoese rent\HouseRent\resources\views/fontend/inc/aboutUs.blade.php ENDPATH**/ ?>