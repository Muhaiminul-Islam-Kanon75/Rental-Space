        ...
        <div class="row">
            <div class="col-md-9 full-width-content">
                <div class="image-content gradient-circle">
                    <div>
                        <span>
                            <img src="<?php echo e(asset('fontend')); ?>/assets/images/about-page-johan.png" alt="johan" />
                        </span>
                    </div>
                </div><!-- /.image-content -->
               ...
               <div class="author-sign pull-right">
                   <img src="<?php echo e(asset('fontend')); ?>/assets/images/sine.png" alt="sine" />
               </div><!-- /.author-sign -->
            </div><!-- /.col-md-7 -->
        </div><!-- /.riv row -->
    </div><!-- /.container -->
...
<?php echo $__env->make('layouts.fontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mikan\Desktop\FALL 2021\cse499b\HouseRent\resources\views/fontend/about.blade.php ENDPATH**/ ?>